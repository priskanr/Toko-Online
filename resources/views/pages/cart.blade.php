                ...
                <div class="row mb-2" data-aos="fade-up" data-aos-delay="200">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="address_one" name="address_one" value="Perum Doboku Ligar"/>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="address_two">Address 2</label>
                            <input type="text" class="form-control" id="address_two" name="address_two" value="Blok K No. 06" />
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
