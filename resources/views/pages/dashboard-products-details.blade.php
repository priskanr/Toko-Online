...
@section('title')
    Priska Store Dashboard Product Detail
@endsection
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="price" value="{{ $product->name }}" />
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                            ...
                            <div class="row">
                                @foreach ($product->galleries as $gallery)
                                    <div class="col-md-4">
                                        <div class="gallery-container">
                                            ...
                                            <a class="delete-gallery" href="{{ route('dashboard-products-gallery-delete', $gallery->id) }}" class="delete-gallery">
                                ...
                                <div class="col-12">
                                    <form action="{{ route('dashboard-products-gallery-upload') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <button type="button" class="btn btn-secondary btn-block" onclick="thisFileUpload();"> Add Photo </button>
                                    </form>
                                </div>
                            </div>
                        </div>
