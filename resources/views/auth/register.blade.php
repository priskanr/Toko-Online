                ...
                <div class="col-lg-4">
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input id="email" v-model="email" @change="checkEmailAvailability()" type="email" class="form-control @error('email') is-invalid @enderror" :class="{'is-invalid' : this.email_unavailable }" name="email" value="{{ old('email') }}" required autocomplete="email">
                                @error('email')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <button type="submit" class="btn btn-success btn-block mt-4" :disabled="this.email.unavailable">Sign Up Now</button>
                        <a href={{ route('login') }} type="submit" class="btn btn-signup btn-block mt-2">Back to Sign In</a>
                    </form>
                </div>
            </div>
        </div>
...
@push('addon-script')
<script src="/vendor/vue/vue.js"></script>r
...
<script>
    ...
    data() {
        return {
            name: "Priska Nur Yustiyani",
            email: "priskanuryustiyani@gmail.com",
            is_store_open: true,
            store_name: "",
